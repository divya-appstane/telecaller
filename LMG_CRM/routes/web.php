        ...
        Route::middleware('guest:front')->group(
            function()
            {
                ...
                Route::middleware('rolepermission:super-admin')->prefix('/admin')->name('admin.')->group(
                    function()
                    {
                        ...
                        Route::prefix('/role-permission')->name("role-permission.")->group(
                            function()
                            {
                                // Route::get('/addNewPermission', [RolePermissionController::class, 'create'])->name('add.createPermission');
                                ...
                                // Route::get('/editPermission/{id}', [RolePermissionController::class, 'show'])->name('show.editPermission');
                                // Route::post('/updatePermission', [RolePermissionController::class, 'update'])->name('updatePermission');
                            }
                        );
                ...
                Route::middleware('rolepermission:business-development-associate|business-development-executive|business-development-manager')->prefix('/telecaller')->name("telecaller.")->group(
                    function()
                    {
                        Route::get('/dashboard', [TelecallerDashboard::class, 'index'])->name('dashboard');
                        Route::prefix('/leads')->name("leads.")->group(
                            function()
                            {
                ...
                Route::middleware('rolepermission:customer-relationship-executive|customer-relationship-manager')->prefix('/crm')->name("crm.")->group(
                    function()
                    {
                        Route::get('/dashboard', [CrmDashboard::class, 'index'])->name('dashboard');
                        Route::prefix('/leads')->name("leads.")->group(
                            function()
                            {
                                ...
                                Route::get('/createSession', [CrmLeadsController::class, 'createsession'])->name('store.createSession');
                            }
                        );
                    }
                );
                ...
                //     function() {
                //         Route::get('/addNewArea', [AreaController::class, 'index'])->name('view');
                //         Route::post('/toggleAeraStatus', [AreaController::class, 'changeAreaStatus'])->name('changeStatus');
                //     }
                // );
                Route::prefix('/area')->name("area.")->group(
                    function() {
