...
@section('main-section')
    @push('css')
        <link href="{{env('USER_ASSETS')}}vendors/apexcharts/dist/apexcharts.css" rel="stylesheet">
    @endpush
    <!-- Content START -->
    <div class="content">
        <div class="main">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px;">
                                                    <img src="{{env('USER_ASSETS')}}images/avatars/thumb-1.jpg">
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr class="cursor-pointer">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px;">
                                                    <img src="{{env('USER_ASSETS')}}images/avatars/thumb-2.jpg">
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr class="cursor-pointer">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px;">
                                                    <img src="{{env('USER_ASSETS')}}images/avatars/thumb-3.jpg">
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr class="cursor-pointer">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px;">
                                                    <img src="{{env('USER_ASSETS')}}images/avatars/thumb-4.jpg">
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr class="cursor-pointer">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px;">
                                                    <img src="{{env('USER_ASSETS')}}images/avatars/thumb-5.jpg">
                                                </div>
                                                <div class="ms-2">
                            ...
                            <div class="scrollable position-relative" style="height: 365px;">
                                    ...
                                    <div class="d-flex pe-3">
                                        <div class="mt-1">
                                            <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px; line-height: 35px;">
                                                <img src="{{env('USER_ASSETS')}}images/avatars/thumb-6.jpg" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="my-3 border-bottom">
                                    <div class="d-flex pe-3">
                                        <div class="mt-1">
                                            <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px; line-height: 35px;">
                                                <img src="{{env('USER_ASSETS')}}images/avatars/thumb-7.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="ms-2 w-100">
                                            <div class="mb-2 d-md-flex justify-content-between align-items-center">
                                ...
                                <div class="my-3 border-bottom">
                                    <div class="d-flex pe-3">
                                        <div class="mt-1">
                                            <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px; line-height: 35px;">
                                                <img src="{{env('USER_ASSETS')}}images/avatars/thumb-8.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="ms-2 w-100">
                                            <div class="mb-2 d-md-flex justify-content-between align-items-center">
                                ...
                                <div class="my-3 border-bottom">
                                    <div class="d-flex pe-3">
                                        <div class="mt-1">
                                            <div class="avatar avatar-circle avatar-image" style="width: 35px; height: 35px; line-height: 35px;">
                                                <img src="{{env('USER_ASSETS')}}images/avatars/thumb-9.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="ms-2 w-100">
                                            <div class="mb-2 d-md-flex justify-content-between align-items-center">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center my-2">
                                                    <div class="avatar avatar-circle avatar-image" style="width: 30px; height: 30px; line-height: 30px;">
                                                        <img src="{{env('USER_ASSETS')}}images/thumbs/us.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center my-2">
                                                    <div class="avatar avatar-circle avatar-image" style="width: 30px; height: 30px; line-height: 30px;">
                                                        <img src="{{env('USER_ASSETS')}}images/thumbs/german.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center my-2">
                                                    <div class="avatar avatar-circle avatar-image" style="width: 30px; height: 30px; line-height: 30px;">
                                                        <img src="{{env('USER_ASSETS')}}images/thumbs/japan.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center my-2">
                                                    <div class="avatar avatar-circle avatar-image" style="width: 30px; height: 30px; line-height: 30px;">
                                                        <img src="{{env('USER_ASSETS')}}images/thumbs/italy.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center my-2">
                                                    <div class="avatar avatar-circle avatar-image" style="width: 30px; height: 30px; line-height: 30px;">
                                                        <img src="{{env('USER_ASSETS')}}images/thumbs/spain.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
    ...
    @push('scripts')
        {{-- <script src="{{env('USER_ASSETS')}}vendors/apexcharts/dist/apexcharts.min.js"></script> --}}
        <script src="{{env('USER_ASSETS')}}js/pages/dashboard.js"></script>
    @endpush
@endsection