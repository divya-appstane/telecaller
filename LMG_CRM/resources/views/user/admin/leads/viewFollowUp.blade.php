        ...
        <div class="main">
            <div class="page-header">
                ...
                <div class="breadcrumb">
                   ...
                   <div class="breadcrumb-item"><a href="{{route('admin.leads.view.followUpsDetails', ['id' => base64_encode($lead_id)])}}"> View Follow-up Details </a></div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                                ...
                                @if(!is_null($leadFollowup))
                                    ...
                                    {{-- <pre>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="{{route('admin.leads.view.singleFollowUpsDetails', ['id' => base64_encode($lead->followup_id)])}}"><i class="icon-eye feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                        </tr>                                
                                    @endforeach
                                @endif
                            </tbody>
