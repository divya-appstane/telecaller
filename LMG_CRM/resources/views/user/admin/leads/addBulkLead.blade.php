    ...
    <div class="main">
        <div class="page-header">
            ...
            <div class="breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{route('admin.leads.add.bulkLeadForm')}}"> Add Bulk Leads </a></div>
            </div>
            <div class="form-group ms-auto"><a href="{{route('admin.leads.add.sigleLeadForm')}}" class="btn btn-success">Add Single Leads</a></div>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form  id="addBulkLeadForm" name="addBulkLeadForm" novalidate enctype="multipart/form-data">
                    @csrf
                    ...
                    <span class="upload_lead_file_error error mb-2"></span>
                    <div class="col-md-3">
                    ...
                    <span class="send_to_error error mb-2"></span>
            ...
            $(document).ready(function(){
                ...
                $('#addBulkLeadForm').validate({
                    ...
                    messages: {
                        ...
                        send_to: {
                            required: "Please select the employee name to be added",
                        },
                    },
                    ...
                    errorPlacement: function(error, element) {
                        if(element.attr("name") == "upload_lead_file") {
                            $('.upload_lead_file_error').html(error);
                        } else if(element.attr("name") == "send_to") {
                            $('.send_to_error').html(error);
                        } else {
                ...
                $('#update_lead').on('click', function() {
                    ...
                    if(valid){
                        ...
                        $.ajax({
                            url:"{{route('admin.leads.store.bulkLead')}}",  
                            method:"POST",  
                            data:fd,  
                            contentType:false, 
                            processData:false,  
