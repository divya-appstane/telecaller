    ...
    <div class="main">
        <div class="page-header">
            ...
            <div class="breadcrumb">
               ...
               <div class="breadcrumb-item"><a href="{{route('admin.leads.view.single', ["id" => base64_encode($single_lead->id)])}}"> View Single Leads </a></div>
            </div>
        </div>
        <div class="card">
            ...
            $(document).ready(function(){
                ...
                $('#update_lead').on('click', function() {
                    ...
                    if(valid){
                        ...
                        $.ajax({
                            url: "{{route('admin.leads.update.single')}}",
                            type: 'POST',
                            data: fd,
                            processData: false,
                            contentType: false,
