...
<div class="main">
    <div class="page-header">
        ...
        <div class="breadcrumb">
           ...
           <div class="breadcrumb-item"><a href="{{route('crm.leads.view.pendingLeads')}}"> View pending Leads </a></div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
                            ...
                            @foreach ($pending_leads as $lead)
                                <tr>
                                    ...
                                    @if ($lead->lead_status == "10" || $lead->lead_status == "12")
                                        <td class="text-center"><a href="{{route('crm.leads.view.feedbackCallView', ['id' => base64_encode($lead->id)])}}"><i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                        
                                    @elseif($lead->lead_status == "13" || $lead->lead_status == "14")
                                        <td class="text-center"><a href="{{route('crm.leads.view.feedbackCallViewStepTwo', ['id' => base64_encode($lead->id)])}}"><i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                        
                                    @elseif($lead->lead_status == "15" || $lead->lead_status == "16" || $lead->lead_status == "17")
                                        <td class="text-center"><a href="{{route('crm.leads.view.feedbackCallViewStepThree', ['id' => base64_encode($lead->id)])}}"><i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                        
                                    @elseif($lead->lead_status == "11")
                                        <td class="text-center"><a href="{{route('crm.leads.view.feedbackCallViewNotIntersted', ['id' => base64_encode($lead->id)])}}"><i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                        
                                    @else
                                        <td class="text-center"> - </td>
                                    @endif
                                    <td class="text-center"><a href="{{route('crm.leads.view.followUpsDetails', ['id' => base64_encode($lead->id)])}}"><i class="icon-list feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                </tr>                                
                            @endforeach
                        @endif
                    </tbody>
