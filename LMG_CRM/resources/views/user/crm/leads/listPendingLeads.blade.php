        ...
        <div class="main">
            <div class="page-header">
                ...
                <div class="breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('crm.leads.view.pendingLeads') }}"> View pending Leads
                        </a></div>
                </div>
            </div>
            <div class="card">
                                    ...
                                    @foreach ($pending_leads as $lead)
                                        <tr>
                                            ...
                                            <td class="text-center"><a
                                                    href="{{ route('crm.leads.view.followUpsDetails', ['id' => base64_encode($lead->id)]) }}"><i
