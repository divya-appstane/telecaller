                        ...
                        <div class="control-group" >
                            ...
                            <p>    
                                <label class="radio-inline">
                                    <input type="radio" name="first_conf" class="first_conf" value="Y"> हाँ
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="first_conf" class="first_conf" value="N"> नहीं
                                </label>
                            </p>
                            ...
                            <div id="no_appinment_timestamp" class="col-md-3 mt-3">
                                ...
                                <p>
                                    ...
                                    &nbsp;
                                    <div>
                                        <button type="button" class="btn btn-danger" onclick="$('#recall_date').val('');$('#start_time').val('');">Clear</button>
                                    </div>
                                </p>
                            </div>
