...
<div class="main">
    <div class="page-header">
        ...
        <div class="breadcrumb">
           ...
           <div class="breadcrumb-item"><a href="{{route('telecaller.leads.pendingLeads')}}"> View pending Leads </a></div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
                        ...
                        @if(!is_null($pending_leads))
                            ...
                            {{-- <pre>
                                ...
                                <tr>
                                    ...
                                    @if ($lead->lead_status == 1)
                                        <td class="text-center"><a href="{{route('telecaller.leads.view.leadCalledEngagementView', ['id' => base64_encode($lead->id)])}}"><i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                    @elseif($lead->lead_status == "2" || $lead->lead_status == "4" || $lead->lead_status == "5")
                                        <td class="text-center"><a href="{{route('telecaller.leads.view.leadCalledReEngagementView', ['id' => base64_encode($lead->id)])}}"><i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                    @else
                                        <td class="text-center"> - </td>
                                    @endif
                                    <td class="text-center"><a href="{{route('telecaller.leads.view.single', ['id' => base64_encode($lead->id)])}}"><i class="icon-search feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                    <td class="text-center"><a href="{{route('telecaller.leads.view.followUpsDetails', ['id' => base64_encode($lead->id)])}}""><i class="icon-list feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                </tr>                                
                            @endforeach
                        @endif
                    </tbody>
