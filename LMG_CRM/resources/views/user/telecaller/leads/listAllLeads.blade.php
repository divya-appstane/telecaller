        ...
        <div class="main">
            <div class="page-header">
                ...
                <div class="breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('telecaller.leads.view.allLeads') }}"> View all Leads
                        </a></div>
                </div>
            </div>
            <div class="card">
                                    ...
                                    @foreach ($all_leads as $lead)
                                        <tr>
                                            ...
                                            @if ($lead->lead_status == 1)
                                                <td class="text-center">
                                                    {{-- @if ($lead->call_date <= date('Y-m-d')) --}}
                                                        <a href="#" class="countdowntimer" data-id="@php echo time(); @endphp" data-action="{{route('telecaller.leads.view.leadCalledEngagementView', ['id' => base64_encode($lead->id)])}}">
                                            ...
                                            @elseif($lead->lead_status == '2' || $lead->lead_status == '4' || $lead->lead_status == '5')
                                                <td class="text-center">
                                                    {{-- @if ($lead->call_date <= date('Y-m-d')) --}}
                                                            <a href="#" class="recalltimer" data-id="@php echo time(); @endphp" data-action="{{ route('telecaller.leads.view.leadCalledReEngagementView', ['id' => base64_encode($lead->id)]) }}">
                                                            <i class="icon-phone-call feather" style="font-size: 24px; font-weight:bold;"></i>
                                                        </a>
                                                    {{-- @else
                                                        <p class="text-center">-</p>
                                            ...
                                            <td class="text-center"><a
                                                    href="{{ route('telecaller.leads.view.single', ['id' => base64_encode($lead->id)]) }}">
                                                    <i  class="icon-search feather" style="font-size: 24px; font-weight:bold;"></i></a></td>
                                            <td class="text-center">
                                                <a href="{{ route('telecaller.leads.view.followUpsDetails', ['id' => base64_encode($lead->id)]) }}">
                                                    <i class="icon-list feather" style="font-size: 24px; font-weight:bold;"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
