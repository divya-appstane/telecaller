...
@section('main-section')
    ...
    <div class="content">
        <div class="main">
            <div class="page-header">
                ...
                <div class="breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('marketing.leads.view.allLeads') }}"> View all Leads </a>
                    </div>
                    <div class="breadcrumb-item"><a
                            href="{{ route('marketing.leads.view.single', ['id' => base64_encode($single_lead->id)]) }}">
                            Sales Meeting Updates </a></div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" id="leadInformationForm" name="leadInformationForm" novalidate
                        enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="col-md-6">
                            <label for="sellername" class="form-label">Shop Name</label><span
                                class="text-danger">&nbsp;*</span>
                            <input type="text" class="form-control {{ $errors->has('sellername') ? 'is-invalid' : '' }}"
                                id="sellername" name="sellername"
                                value="{{ old('sellername') ?? $single_lead->company_name }}" />
                        </div>
                        @error('sellername')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="contperson" name="contperson"
                                value="{{ old('contperson') ?? $single_lead->contact_per_name }}">
                        </div>
                        <div class="col-md-6">
                            <label for="contnum" class="form-label">Contact Number</label><span
                                class="text-danger">&nbsp;*</span>
                            <input type="number" class="form-control" id="contnum" name="contnum"
                                value="{{ old('contnum') ?? $single_lead->contact_number }}">
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email"
                                value="{{ old('email') ?? $single_lead->email }}">
                        </div>
                        <div class="col-md-3">
                            <label for="designation" class="form-label">Designation</label>
                            <input type="text" class="form-control" id="designation" name="designation"
                                value="{{ old('designation') ?? $single_lead->designation }}">
                        </div>
                        <div class="col-md-3">
                            <label for="address" class="form-label">Company Address</label>
                            <input type="text" class="form-control" id="address" name="address"
                                value="{{ old('address') ?? $single_lead->address }}">
                        </div>
                        <div class="col-md-2">
                            <label for="city" class="form-label">City</label><span class="text-danger">&nbsp;*</span>
                            <input type="text" class="form-control" id="city" name="city"
                                value="{{ old('city') ?? $single_lead->city }}">
                        </div>
                        <div class="col-md-2">
                            <label for="state" class="form-label">State</label><span class="text-danger">&nbsp;*</span>
                            <input type="text" class="form-control" id="state" name="state"
                                value="{{ old('state') ?? $single_lead->state }}">
                        </div>
                        <div class="col-md-2">
                            <label for="pincode" class="form-label">Pincode</label><span
                                class="text-danger">&nbsp;*</span>
                            <input type="text" class="form-control" id="pincode" name="pincode"
                                value="{{ old('pincode') ?? $single_lead->pincode }}">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-8">
                            <label for="offeredcategory" class="form-label">Offered Category</label> <span
                                class="text-danger">&nbsp;*</span>
                            @if (!is_null($all_categories))
                                @foreach ($all_categories as $category)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{ $category->cid }}"
                                            id="cat_id[]" name="cat_id[]"
                                            {{ in_array($category->cid, array_column($single_lead->getLeadCategory->toArray(), 'cat_id')) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <label for="subcategory" class="form-label">Sub-Category:</label><span
                                class="text-danger">&nbsp;*</span>
                            <input type="text" class="form-control" id="subcategory" name="subcategory"
                                value="{{ old('subcategory') }}"
                                placeholder="Enter seller sub-category (comma seperated values)">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="latitude" name="latitude" value=""
                                placeholder="Latitude value we display here automatically" readonly />
                        </div>
                        <div class="col-md-3">
                            <label for="longitude" class="form-label">Longitude</label>
                            <input type="text" class="form-control" id="longitude" name="longitude" value=""
                                placeholder="Longitude value we display here automatically" readonly />
                        </div>
                        <div class="col-md-6">
                            <label for="gst_number" class="form-label">GST Number</label>
                            <input type="text" class="form-control" id="gst_number" name="gst_number"
                                value="{{ old('gst_number') ?? $single_lead->gst_number }}"
                        ...
                        <div class="col-md-6">
                            <label for="photo" class="form-label">Shop Photo<span
                                    class="text-danger">&nbsp;*</span></label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><i
                                        class="icon-upload feather"></i></span>
                                <input type="file" class="form-control" id="photo" name="photo"
                                    accept="image/*" capture="camera" />
                                {{-- <div id="my_camera"></div> --}}
                            <br/>
                            {{-- <input type=button value="Take Snapshot" onClick="take_snapshot()">
                            <input type="hidden" name="photo" id="photo" class="image-tag"> --}}
                            </div>
                            {{-- <div id="results">Your captured image will appear here...</div> --}}
                            <div class="error"></div>
                        </div>
                        <div class="col-md-6">
                            <label for="selreg" class="form-label">Seller Register</label><span
                                class="text-danger">&nbsp;*</span>
                        ...
                        <div class="col-md-8 d-none" id="selappdate">
                            ...
                            <div class="row">
                                <input type="text" name="sappoinment_date" id="sappoinment_date" value=""
                                    placeholder="Enter Appointment Date" data-date-format="yyyy-mm-dd"
                                    class="datepicker col-md-4 form-control" autocomplete="randomFeed" />
                                &nbsp;
                                <input type="text" name="sappoinment_time" id="sappoinment_time" value=""
                                    class="timepicker col-md-4 form-control" placeholder="Enter Appointment Time"
                                    autocomplete="randomFeed" />
                                <button type="button" class="btn btn-danger col-md-4 mt-2"
                                    onclick="$('#sappoinment_date').val('');$('#sappoinment_time').val('');">Clear</button>
                            </div>
                        </div>
        ...
        {{-- <div class="">
            ...
            <input type="checkbox" id="flipImage">Flip Image
            <table>
                <tbody>
                    <tr>
                        <td valign="top"><span>Camera:</span><br>
                            <div id="container"><video></video></div>
                        </td>
        ...
        @push('scripts')
            ...
            <script src="https://riversun.github.io/webcam.js/example/00_overview/js/webcam.js"></script>
            <script>
                                ...
                                success: function(response) {
                                    ...
                                    setTimeout(() => {
                                        window.location.href =
                                            `{{ route('marketing.leads.view.allLeads') }}`;
                                    }, pageReloadTimeOut);
                                },
                                error: function(data) {
                                    if (data.status === 500) {
