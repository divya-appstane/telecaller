    ...
    <div class="main">
        <div class="page-header">
            ...
            <div class="breadcrumb">
               ...
               <div class="breadcrumb-item"><a href="{{route('area.editArea', ['id' => base64_encode($singlearea->id)])}}"> Update area </a></div>
            </div>
        </div>
        <div class="card">
            <div class="updateStatus"></div>
            <div class="card-body">
                <h4>Update Area</h4><br/>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="area_name" name="area_name" placeholder="Enter area name" value="{{$singlearea->area_name}}" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                @foreach($all_areas as $area)
                                    @php $cnt++; @endphp
                                    <input type="checkbox" name="surrounding_area_id[]" value="{{$area->id}}" @if(in_array($area->id, $surrounding_area_id)) checked @endif> 
                                        &nbsp;{{$area->area_name}} &nbsp;&nbsp;
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-control" id="isactive" name="isactive">
                                <option value="1" @if($singlearea->isactive == '1') selected @endif>Yes</option>
                                <option value="0" @if($singlearea->isactive == '0') selected @endif>No</option>
                            </select>
                        </div>
                    </div>
                    <span class="isactive error mb-2"></span>

                    <input type="hidden" name="areaid" id="areaid" value="{{$singlearea->id}}" />
